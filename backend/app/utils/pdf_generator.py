...
#     pdf.set_font("Arial", "", 12)
#     corps = f"""
# Cher/Chère {nom_complet},

# Suite à l'entretien disciplinaire et à la décision prise, nous vous informons que votre contrat de travail est malheureusement résilié pour motif disciplinaire.
